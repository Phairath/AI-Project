...
if page_selected == 'Model':
    ...
    if btn1:
        ...
        st.markdown(
            ...
            <strong> Disclaimer : </strong> The survival predictions provided are based on 
            virtual data from the Road Accident Survival Dataset generated by ChatGPT. 
            These results are for entertainment purposes only and may not be applicable 
            to real-life situations or other datasets</p>""",
            unsafe_allow_html=True)
